...
class EDiscountRule:
    ...
    def decide_coupon_to_apply(
        ...
        try:
            ...
            self.logger.info(f"[E 매장] 추가 필요한 쿠폰 계산 완료: {len(applications)}개")
            ...
            for app in applications:
                ...
                if config:
                    ...
                    self.logger.info(f"[E 매장] {app.coupon_name}: {app.count}개 ({app.count * config.duration_minutes}분)")
            ...
            self.logger.info(f"[E 매장] 추가 적용 시간: {total_apply_minutes}분")
